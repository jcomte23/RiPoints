...
export async function modal(element) {
  info.forEach(coder => {
    ...
    element.innerHTML += `
    <div class="modal fade" id="exampleModal-${coder.id}" data-id="${coder.id}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
                ...
                <h4 class="center__text">${coder.name}</h4>
                </div>
                  </div>
                  <div class="last__name">
                    <h4 for="lastname">Apellido:</h4>
                    <div class="center__text">
                      <h4 class="center__text">${coder.lastName}</h4>
                    </div>
                  </div>
                  <div class="clan">
                    <h4 for="clan">Clan:</h4>
                ...
                <div class="container__profile">
                  ...
                  <div class="container__points">
                    <div class="total__points" id="totalPoints">${Object.entries(coder.day_point).reduce((acc, curr) => Number(curr[1]) + acc, 0)}</div>
